...
TEST_F(IrLgTest, NullRequiredFieldsSkipsEntryAndStillSends) {
  ...
  std::string payload =
    R"([{"deviceUuid":"d","mac":"m","model":"ac-lg","featureUuid":"f","featureName":"on","value":1}])";
  sendCommand(payload);
...
TEST_F(IrLgTest, OnValueZeroEarlyReturnSkipsRemainingFeatures) {
  ...
  std::string payload =
    R"([)"
    R"({"apiToken":"473a4861-632b-4915-b01e-cf1d418966c6","deviceUuid":"d","mac":"m","model":"ac-lg","featureUuid":"f1","featureName":"on","value":0},)"
    R"({"apiToken":"473a4861-632b-4915-b01e-cf1d418966c6","deviceUuid":"d","mac":"m","model":"ac-lg","featureUuid":"f2","featureName":"setpoint","value":22})"
    R"(])";
  sendCommand(payload);
...
TEST_F(IrLgTest, MultipleFeaturesAllAppliedWithSingleSend) {
  ...
  std::string payload =
    R"([)"
    R"({"apiToken":"473a4861-632b-4915-b01e-cf1d418966c6","deviceUuid":"d","mac":"m","model":"ac-lg","featureUuid":"f1","featureName":"on","value":1},)"
    R"({"apiToken":"473a4861-632b-4915-b01e-cf1d418966c6","deviceUuid":"d","mac":"m","model":"ac-lg","featureUuid":"f2","featureName":"setpoint","value":24},)"
    R"({"apiToken":"473a4861-632b-4915-b01e-cf1d418966c6","deviceUuid":"d","mac":"m","model":"ac-lg","featureUuid":"f3","featureName":"mode","value":1},)"
    R"({"apiToken":"473a4861-632b-4915-b01e-cf1d418966c6","deviceUuid":"d","mac":"m","model":"ac-lg","featureUuid":"f4","featureName":"fanSpeed","value":2})"
    R"(])";
  sendCommand(payload);
