...
// Controllable digitalRead — tests set g_digital_read_value before calling
// pir_get_value() to simulate different GPIO states without real hardware.
inline int g_digital_read_value = 0;
inline int digitalRead(uint8_t /*pin*/) { return g_digital_read_value; }
