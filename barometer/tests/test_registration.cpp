...
static std::string valid_response() {
  return std::string(
    ...
    + R"(","model":")"
    + MODEL
    + R"(","features":[{"uuid":"feat-uuid-0000-0000-000000000001","type":"sensor","name":"airpressure","enable":true,"order":1,"unit":"hPa"},{"uuid":"feat-uuid-0000-0000-000000000002","type":"sensor","name":"temperature","enable":true,"order":2,"unit":"°C"}]})";
}
